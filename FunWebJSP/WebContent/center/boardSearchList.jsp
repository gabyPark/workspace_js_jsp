...
<h1>검색 전용 게시판</h1>
	<table id="notice">
		...
		%>
		    ...
		    %>
				<a href="boardSearchList.jsp?pageNum=<%=startPage-pageBlock%>">Prev</a>
			<%
		     }
			%>
			...
			%>
				<a href="boardSearchList.jsp?pageNum=<%=i %>&search=<%=search%>"><%=i %></a>
			<%
			  } 
			%>
			...
			<%
			  if(endPage<pageCount){
			%>
				<a href="boardSearchList.jsp?pageNum=<%=startPage+pageBlock%>">Next</a>
			<%
			  }
			%>
